 ...
 *    resume-seam registration of vouched-for legacy event types into
 ...
 *    registration API (issue #153) — and the bounded read-only log reader
 *    behind the session tree (readSessionEventsFromLog/FromFile).
